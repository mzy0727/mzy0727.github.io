...
function() {
    ...
    function(t) {
        ...
        n = t.clientX,
        t = t.clientY,
        "number" == typeof d && "number" == typeof h && (a = n - d, e = t - h, y.tx = y.x + a / 8 * o * 1, y.ty = y.y + e / 8 * o * 1),
        d = n,
        h = t
    }),
